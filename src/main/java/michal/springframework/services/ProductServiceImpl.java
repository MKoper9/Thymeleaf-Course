...
import michal.springframework.domain.Author;
import michal.springframework.domain.Product;
import michal.springframework.domain.ProductCategory;
...
public class ProductServiceImpl implements ProductService {
    ...
    private void loadProducts(){
        Author mk = new Author();
        mk.setFirstName("Michał");
        mk.setLastName("Koperski");
        mk.setId(1);
        mk.setImage("kulfon.png");
        ...
        springIntro.setImageUrl("kotek2.jpg");
        ...
        springCoreUltimate.setAuthor(mk);
        ...
        thymeleaf.setImageUrl("kotek4.jpg");
        ...
        springCore.setImageUrl("kotek5.jpg");
        ...
        springCoreAdv.setImageUrl("kotek6.jpg");
